    ...
    <div class="row">
      <div class="d-flex justify-content-end">
        <button class="btn btn-primary" 
          ...
          title="New Category" route={{ route('admin.categories.store') }}
        > New Category </button>
      </div>
    </div>
    <div class="row">
                ...
                <tbody>
                  @foreach ($categories as $category)
                    <tr>
                      ...
                      <td>
                        {{ \Carbon\Carbon::parse($category->serving_time_start)->format('h:i A') . " - " . \Carbon\Carbon::parse($category->serving_time_end)->format('h:i A')}}
                      </td>
                      ...
                      <td class="align-middle">
                        <a href="javascript:;" class="btn text-secondary font-weight-bold text-xs" 
                          ...
                          data-bs-toggle="modal" data-bs-target="#category" data='{!! json_encode($category) !!}'
                          title="Edit Item" route={{ route('admin.categories.update', ['id' => $category->id]) }}>
                          Edit
                        </a>
                      </td>
                    </tr>  
          ...
          <div class="modal-content">
              ...
              <div class="card-body">
                  ...
                  <div class="input-group mb-3">
                      <input type="text" name="name" class="form-control" placeholder="Name" aria-label="Name" required="true">
                  </div>
                  ...
                  <div class="text-center">
                      <button type="submit" class="btn btn-round bg-gradient-info btn-lg w-100 mt-4 mb-0">Save Category</button>
                  </div>
              </div>
              </div>
          </div>
...
<script>
  ...
  document.getElementById('category').addEventListener('show.bs.modal', function(event){
